...
int maindddd( int argc, char** argv )
{
  ...
  // otherwise default to capture from attached H/W camera		cvLoadImage("E://²âÊÔÍ¼Æ¬/1.jpg", 1);
  argc = 2;
    if( 
		(argc == 2 && (img = cvLoadImage("E://²âÊÔÍ¼Æ¬/1.jpg", 1)) != 0) ||
